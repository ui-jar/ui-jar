...
* **--includes** (RegExp) - space separated list of files to include, should be of type RegExp e.g. "foo\\.ts$ bar\\.ts$"
* **--excludes** (RegExp) - space separated list of files to exclude, should be of type RegExp e.g. "a\\.component\\.ts$ b\\.component\\.ts$"
